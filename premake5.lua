...
newaction({
  ...
  onWorkspace = function(wks)
    local rootLoc = _MAIN_SCRIPT_DIR or "."
    -- get old version number from version.hpp if any
    local oldVersion = "(none)"
    local oldVersionHeader = io.open(rootLoc .. "/src/version.h", "r")
    ...
    if oldVersion ~= gitDescribeOutputQuoted then
      ...
      local versionFile = assert(io.open(rootLoc .. "/version.txt", "w"))
...
if incrementallink == nil then incrementallink = noop end
if minimalrebuild == nil then minimalrebuild = noop end
if multiprocessorcompile == nil then multiprocessorcompile = noop end
if enable64bitchecks == nil then enable64bitchecks = noop end
if editandcontinue == nil then editandcontinue = noop end
if staticruntime == nil then staticruntime = noop end
if characterset == nil then characterset = noop end
if runtimechecks == nil then runtimechecks = noop end
if buffersecuritycheck == nil then buffersecuritycheck = noop end
if nodefaultlib == nil then nodefaultlib = noop end
